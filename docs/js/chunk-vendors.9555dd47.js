 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Se(){return"undefined"!==typeof Te()["WorkerGlobalScope"]&&"function"===typeof Te()["importScripts"]}async function ke(){if(!(null===navigator||void 0===navigator?void 0:navigator.serviceWorker))return null;try{const t=await navigator.serviceWorker.ready;return t.active}catch(t){return null}}function Ce(){var t;return(null===(t=null===navigator||void 0===navigator?void 0:navigator.serviceWorker)||void 0===t?void 0:t.controller)||null}function Ae(){return Se()?self:null}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn=new R(3e4,6e4);function kn(){const t=Te().___jsl;if(null===t||void 0===t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let n=0;n<t.CP.length;n++)t.CP[n]=null}function Cn(t){return new Promise(((e,n)=>{var r,i,s;function o(){kn(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{kn(),n(p(t,"network-request-failed"))},timeout:Sn.get()})}if(null===(i=null===(r=Te().gapi)||void 0===r?void 0:r.iframes)||void 0===i?void 0:i.Iframe)e(gapi.iframes.getContext());else{if(!(null===(s=Te().gapi)||void 0===s?void 0:s.load)){const e=We("iframefcb");return Te()[e]=()=>{gapi.load?o():n(p(t,"network-request-failed"))},Ge(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw An=null,t}))}let An=null;function Rn(t){return An=An||Cn(t),An}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Si(t){if(t.code!==Xr.FAILED_PRECONDITION||t.message!==Ti)throw t;zr("LocalStore","Unexpectedly lost primary lease")}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class _l{constructor(t,e,n){this.converter=e,this._key=n,this.type="document",this.firestore=t}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Tl(this.firestore,this.converter,this._key.path.popLast())}withConverter(t){return new _l(this.firestore,t,this._key)}}class El{constructor(t,e,n){this.converter=e,this._query=n,this.type="query",this.firestore=t}withConverter(t){return new El(this.firestore,t,this._query)}}class Tl extends El{constructor(t,e,n){super(t,e,Fs(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const t=this._path.popLast();return t.isEmpty()?null:new _l(this.firestore,null,new yi(t))}withConverter(t){return new Tl(this.firestore,t,this._path)}}function Il(t,e,...n){if(t=(0,a.m9)(t),fl("collection","path",e),t instanceof bl){const r=pi.fromString(e,...n);return gl(r),new Tl(t,null,r)}{if(!(t instanceof _l||t instanceof Tl))throw new Yr(Xr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pi.fromString(e,...n));return gl(r),new Tl(t.firestore,null,r)}}function Sl(t,e,...n){if(t=(0,a.m9)(t),1===arguments.length&&(e=ci.I()),fl("doc","path",e),t instanceof bl){const r=pi.fromString(e,...n);return ml(r),new _l(t,null,new yi(r))}{if(!(t instanceof _l||t instanceof Tl))throw new Yr(Xr.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(pi.fromString(e,...n));return ml(r),new _l(t.firestore,t instanceof Tl?t.converter:null,new yi(r))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.9555dd47.js.map